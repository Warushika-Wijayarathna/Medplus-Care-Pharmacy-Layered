...
import lk.ijse.medpluscarepharmacylayered.view.tm.TestTm;
...
public class TestFormController {
    ...
    private void loadAllTests() {
        obList.clear();
        try {
            List<TestDTO> testList = testBO.getAllTests();
            ...
            testTable.setItems(obList);
             ...
             new Alert(Alert.AlertType.ERROR, "Failed to load test data!").showAndWait();
    ...
    private void handleUpdateTest(TestDTO test) {
    ...
    public void addBtnOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            TestDTO newTest= new TestDTO( desc, lab, sampleType, testType, priceOf);

            testBO.addTest(newTest);

            String generatedTestId = testBO.getGeneratedTestId();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = reader.readLine()) != null) {
                try {
                    ...
                    TestDTO newTest = new TestDTO(desc, lab, sampleType, testType, price);
                    testBO.addTest(newTest);
