...
public class ItemFormController {
    ...
    private void handleUpdateItem(ItemDTO item) {
    ...
    public void addBtnOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            isSaved = itemBO.saveItem(newItem, allSupplierIds);
    ...
    void onSelectOption(ActionEvent event) {
        ...
        if (selectedSupplierName != null) {
            try {
                SupplierTm selectedSupplier = supplierBO.getSupplierTmByName(selectedSupplierName);
